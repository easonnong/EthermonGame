...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      ...
      url: process.env.RINKEBY_RPC_URL || "RINKEBY_RPC_URL", // <---- YOUR INFURA ID! (or it won't work)
    ...
    goerli: {
      chainId: 5,
      blockConfirmations: 6,
      url: process.env.GOERLI_RPC_URL || "GOERLI_RPC_URL", // <---- YOUR INFURA ID! (or it won't work)
    ...
    mumbai: {
      chainId: 80001,
      url: process.env.MUMBAI_RPC_URL || "MUMBAI_RPC_URL",
